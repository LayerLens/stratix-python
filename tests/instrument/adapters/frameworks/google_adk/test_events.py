...
Ported as-is from ``ateam/tests/adapters/google_adk/test_events.py``.
...
class TestGoogleADKAdapterEvents:
    ...
    def test_capture_config_minimal_gates_l3_l5(self, mock_stratix: MockStratix) -> None:
        adapter: GoogleADKAdapter = GoogleADKAdapter(
    ...
    def test_cross_cutting_always_emitted(self, mock_stratix: MockStratix) -> None:
        ...
        adapter.emit_dict_event(
            "agent.state.change", {"framework": "google_adk", "event_subtype": "test"}
        )
