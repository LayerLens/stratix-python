"""Tests for STRATIX LangGraph State Adapter."""

import pytest
import time

from layerlens.instrument.adapters.langgraph.state import (
...
class TestLangGraphStateAdapter:
    ...
    def test_diff_detects_modified_keys(self):
    ...
    def test_include_keys_filter(self):
        ...
        state = {"important": "value", "unimportant": "ignored"}
        snapshot = adapter.snapshot(state)
    ...
    def test_exclude_keys_filter(self):
        ...
        state = {"public": "value", "secret": "hidden"}
        snapshot = adapter.snapshot(state)
    ...
    def test_handles_object_with_dict_attr(self):
...
class TestMessageListAdapter:
    ...
    def test_get_new_messages_returns_added(self):
    ...
    def test_get_new_messages_empty_when_no_new(self):
