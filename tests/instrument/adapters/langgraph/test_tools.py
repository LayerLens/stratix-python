"""Tests for STRATIX LangGraph Tool Tracing."""

import pytest

from layerlens.instrument.adapters.langgraph.tools import (
    ToolTracer,
...
class TestToolTracer:
    ...
    def test_trace_emits_tool_call_event(self):
...
class TestTraceLanggraphToolDecorator:
    ...
    def test_decorator_with_stratix(self):
    ...
    def test_decorator_handles_complex_types(self):
        """Test decorator handles complex input/output types."""
        stratix = MockStratix()

        @trace_langgraph_tool(stratix_instance=stratix)
        def complex_tool(data: dict) -> list:
...
class TestLangGraphToolNode:
    ...
    def test_node_callable_interface(self):
    ...
    def test_node_emits_tool_call(self):
    ...
    def test_node_handles_exception(self):
    ...
    def test_node_full_state_input(self):
