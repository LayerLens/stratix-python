...
class AGUIAdapter(BaseProtocolAdapter):
    """
    LayerLens adapter for the AG-UI (Agent-User Interaction) protocol.
    ...
    def connect(self) -> None:
        try:
            import ag_ui  # type: ignore[import-not-found,unused-ignore]
    ...
    def get_adapter_info(self) -> AdapterInfo:
        return AdapterInfo(
            ...
            description="LayerLens adapter for the AG-UI protocol",
        )
