...
class A2AAdapter(BaseProtocolAdapter):
    """
    Stratix adapter for the A2A (Agent-to-Agent) protocol.
    ...
    def connect(self) -> None:
        try:
            import a2a  # type: ignore[import-untyped]
    ...
    def get_adapter_info(self) -> AdapterInfo:
        return AdapterInfo(
            ...
            description="Stratix adapter for the A2A (Agent-to-Agent) protocol",
        )
    ...
    def serialize_for_replay(self) -> ReplayableTrace:
        return ReplayableTrace(
            ...
            config={
                ...
                "agent_cards": {k: v for k, v in self._agent_cards.items()},
            },
        )
    ...
    def register_agent_card(self, card_data: dict[str, Any], source: str = "discovery") -> None:
        ...
        """
        from layerlens.instrument.schema.events.protocol import AgentCardEvent, SkillInfo
        ...
        event = AgentCardEvent.create(
            ...
            skills=skills,
            auth_scheme=card_data.get("authScheme") or card_data.get("authentication", {}).get("scheme"),
            source=source,
        )
    ...
    def on_task_submitted(
        ...
        *,
        ...
        from layerlens.instrument.schema.events.protocol import TaskSubmittedEvent
    ...
    def on_task_completed(
        ...
        *,
        ...
        from layerlens.instrument.schema.events.protocol import TaskCompletedEvent
    ...
    def on_task_delegation(
        ...
        from layerlens.instrument.schema.events.cross_cutting import AgentHandoffEvent
