...
class BaseProtocolAdapter(BaseAdapter):
    ...
    def __init__(
        ...
        super().__init__(stratix=stratix, capture_config=capture_config, event_sinks=event_sinks)
    ...
    def negotiate_version(self, server_versions: list[str]) -> str | None:
        ...
        for v in reversed(sorted(server_versions)):
    ...
    def _acquire_connection(self, endpoint: str) -> Any:
        ...
        return endpoint  # Placeholder — subclasses manage real connections
    ...
    async def _retry_async(self, coro_factory, *args: Any, **kwargs: Any) -> Any:
        """
