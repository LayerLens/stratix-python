...
def wrap_mcp_tool_call(
    ...
    Returns:
        Wrapped function.
    """
    if getattr(original_fn, "_stratix_original", False):
        return original_fn
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            adapter.on_tool_call(
                ...
                input_data=input_data if isinstance(input_data, dict) else {"args": str(input_data)},
                output_data=output_data,
                error=error_msg,
                latency_ms=latency_ms,
            )

    wrapper._stratix_original = True  # type: ignore[attr-defined]
    return wrapper
