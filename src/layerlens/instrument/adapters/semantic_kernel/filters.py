...
- STRATIXFunctionFilter: Function invocation pre/post hooks
- STRATIXPromptRenderFilter: Prompt template rendering hooks
- STRATIXAutoFunctionFilter: Auto-invoked function hooks
"""
...
class STRATIXPromptRenderFilter:
    """
...
class STRATIXAutoFunctionFilter:
    """
    ...
    async def on_auto_function_invocation(
        ...
        plugin_name = STRATIXFunctionFilter._extract_plugin_name(context)
        function_name = STRATIXFunctionFilter._extract_function_name(context)
        arguments = STRATIXFunctionFilter._extract_arguments(context)
        ...
        try:
            ...
            try:
                result = STRATIXFunctionFilter._extract_result(context)
                self._adapter.on_function_end(
                    context=trace_ctx,
                    result=result,
                    error=error,
