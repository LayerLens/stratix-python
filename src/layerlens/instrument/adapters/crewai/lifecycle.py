...
class CrewAIAdapter(BaseAdapter):
    ...
    Uses the CrewAI callback protocol (v0.41+) via STRATIXCrewCallback.
    ...
    def get_adapter_info(self) -> AdapterInfo:
        return AdapterInfo(
            ...
            description="STRATIX adapter for CrewAI agent framework",
        )
    ...
    def instrument_crew(self, crew: Any) -> Any:
        ...
        Registers STRATIXCrewCallback on the crew. Records process type
        and agent metadata.
        ...
        callback = STRATIXCrewCallback(adapter=self)
