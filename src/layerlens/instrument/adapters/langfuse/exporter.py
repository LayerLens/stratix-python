...
from layerlens.instrument.adapters.langfuse.mapper import STRATIXToLangfuseMapper
...
class TraceExporter:
    ...
    def __init__(
        ...
        self._client = client
        self._state = state
        self._mapper = STRATIXToLangfuseMapper()
    ...
    def export_traces(
        ...
        for trace_id in ids_to_export:
            ...
            # Record success
            self._state.record_export(trace_id, datetime.now(timezone.utc))
            result.exported_count += 1
