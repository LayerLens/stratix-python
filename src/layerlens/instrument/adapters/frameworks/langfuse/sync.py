...
class BidirectionalSync:
    """
    Orchestrates bidirectional sync between Langfuse and LayerLens.
    ...
    def run(
        ...
        Args:
            stratix: LayerLens instance for event emission.
            direction: Sync direction (import, export, or bidirectional).
            since: Override since timestamp.
            dry_run: If True, report what would happen without making changes.
            events_by_trace: LayerLens events for export (required for export/bidirectional).
