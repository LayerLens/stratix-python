...
class LangfuseAdapter(BaseAdapter):
    ...
    def get_adapter_info(self) -> AdapterInfo:
        ...
        return AdapterInfo(
            ...
            author="STRATIX Team",
            description="Bidirectional trace sync between STRATIX and Langfuse",
        )
    ...
    def import_traces(
        ...
        """
        Import traces from Langfuse into STRATIX.
    ...
    def sync(
        ...
        Args:
            ...
            events_by_trace: Required for export/bidirectional — STRATIX events to export.
        ...
        effective_direction = direction or (self._config.mode if self._config else SyncDirection.IMPORT)
        start_time = time.monotonic()
    ...
    def get_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_import_cursor": (
                self._sync_state.last_import_cursor.isoformat() if self._sync_state.last_import_cursor else None
            ),
            "last_export_cursor": (
                self._sync_state.last_export_cursor.isoformat() if self._sync_state.last_export_cursor else None
            ),
        }
