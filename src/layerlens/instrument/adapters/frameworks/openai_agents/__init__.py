...
def instrument_runner(runner: Any = None, stratix: Any = None, capture_config: dict[str, Any] | None = None, org_id: str | None = None) -> Any:
    """Convenience function to instrument OpenAI Agents SDK."""
    adapter = OpenAIAgentsAdapter(stratix=stratix, capture_config=capture_config, org_id=org_id)
    adapter.connect()
