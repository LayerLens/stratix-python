...
class HumanProxyTracer:
    ...
    def __init__(self, adapter: AutoGenAdapter) -> None:
        ...
        self._original_get_human_input: Callable[..., Any] | None = None
    ...
    def wrap_agent(self, agent: Any) -> Any:
        ...
        agent._layerlens_human_tracer = self
    ...
    def _create_traced_get_human_input(
        ...
        traced_get_human_input._layerlens_original = original  # type: ignore[attr-defined]
