...
def create_traced_send(
    ...
    traced_send._layerlens_original = original_send  # type: ignore[attr-defined]
    return traced_send
...
def create_traced_receive(
    ...
    traced_receive._layerlens_original = original_receive  # type: ignore[attr-defined]
...
def create_traced_generate_reply(
    adapter: AutoGenAdapter,
    agent: Any,
    original_generate_reply: Callable[..., Any],
) -> Callable[..., Any]:
    """
    ...
    traced_generate_reply._layerlens_original = original_generate_reply  # type: ignore[attr-defined]
...
def create_traced_execute_code(
    adapter: AutoGenAdapter,
    agent: Any,
    original_execute_code: Callable[..., Any],
) -> Callable[..., Any]:
    """
    ...
    traced_execute_code._layerlens_original = original_execute_code  # type: ignore[attr-defined]
