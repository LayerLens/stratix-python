"""
LayerLens AutoGen Lifecycle Hooks
...
class AutoGenAdapter(BaseAdapter):
    """
    Main adapter for integrating LayerLens with Microsoft AutoGen.

    Uses monkey-patching to intercept ConversableAgent methods (send, receive,
    generate_reply, execute_code_blocks) and emit LayerLens telemetry events.
    ...
    def connect_agents(self, *agents: Any) -> list[Any]:
        """
        Monkey-patch AutoGen agents with LayerLens tracing.
