...
class TracedChain:
    ...
    Automatically injects LayerLensCallbackHandler and tracks
    chain executions.

    Usage:
        from langchain.chains import LLMChain  # type: ignore[import-untyped,unused-ignore]
    ...
    def run(self, *args: Any, **kwargs: Any) -> str:
        ...
        return self._chain.run(*args, **kwargs)  # type: ignore[no-any-return]
