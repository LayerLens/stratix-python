...
Usage:
    ...
    adapter = CrewAIAdapter(stratix=stratix_instance, org_id="org-123")
    adapter.connect()
...
def instrument_crew(crew: Any, stratix: Any = None, capture_config: dict[str, Any] = None, org_id: str | None = None) -> Any:  # type: ignore[assignment]
    """
    ...
    """
    adapter = CrewAIAdapter(stratix=stratix, capture_config=capture_config, org_id=org_id)  # type: ignore[arg-type]
    adapter.connect()
