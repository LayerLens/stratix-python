"""
AgentForce DMO to LayerLens Event Normalizer

Maps AgentForce Data Model Objects to LayerLens canonical event types:
...
# Step type to LayerLens event type mapping
_STEP_TYPE_MAP = {
...
class AgentForceNormalizer:
    """Normalize AgentForce DMO records to LayerLens events."""
    ...
    def normalize_step(
        ...
        """Normalize an AIAgentInteractionStep to the appropriate LayerLens event."""
