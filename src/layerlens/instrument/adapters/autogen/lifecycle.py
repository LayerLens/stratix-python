...
from layerlens.instrument.adapters.autogen.metadata import AutoGenAgentMetadataExtractor
...
class AutoGenAdapter(BaseAdapter):
    ...
    def get_adapter_info(self) -> AdapterInfo:
        return AdapterInfo(
            ...
            description="STRATIX adapter for Microsoft AutoGen framework",
        )
    ...
    def on_execute_code(
        ...
        self.emit_dict_event("tool.environment", {
            "framework": "autogen",
            "agent": agent_name,
