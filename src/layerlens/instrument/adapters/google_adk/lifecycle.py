...
class GoogleADKAdapter(BaseAdapter):
    """Stratix adapter for Google Agent Development Kit."""
    ...
    def get_adapter_info(self) -> AdapterInfo:
        return AdapterInfo(
            ...
            description="Stratix adapter for Google Agent Development Kit",
        )
    ...
    def _after_agent_callback(self, callback_context: Any) -> Any:
        ...
        try:
            ...
            self.emit_dict_event("agent.output", {
                "framework": "google_adk",
                "agent_name": agent_name,
                "output": self._safe_serialize(
                    getattr(callback_context, "agent_output", None)
                ),
    ...
    def _after_model_callback(self, callback_context: Any, llm_response: Any) -> Any:
        ...
        try:
            ...
            model = getattr(callback_context, "model", None) or getattr(
            ...
            if usage:
                ...
                payload["tokens_completion"] = getattr(
    ...
    def _before_tool_callback(
        self, callback_context: Any, tool_name: str, tool_input: Any
    ) -> Any:
        if not self._connected:
            return None
        try:
    ...
    def _emit_agent_config(self, agent_name: str, callback_context: Any) -> None:
        ...
        if agent:
            ...
            if sub_agents:
                metadata["sub_agents"] = [
                    getattr(a, "name", str(a)) for a in sub_agents
                ]
