"""
OpenAI LLM Provider Adapter (ADP-053)

Wraps the OpenAI Python SDK client to intercept chat completions, embeddings,
...
class OpenAIAdapter(LLMProviderAdapter):
    """
    STRATIX adapter for the OpenAI Python SDK.
    ...
    def _wrap_stream(
        ...
        class TracedStream:
                    ...
                    try:
                        ...
                        if final_usage:
                            adapter._emit_cost_record(
                                model=model, usage=final_usage, provider="openai",
                            )
            ...
            def _process_chunk(self, chunk: Any) -> None:
                ...
                # Capture chunk-level response metadata
    ...
    def _extract_usage_from_obj(usage: Any) -> NormalizedTokenUsage:
        """Extract NormalizedTokenUsage from an OpenAI Usage object."""
