...
class TraceRecorder:
    ...
    def _build_attestation(self) -> Dict[str, Any]:
        """Build an unsigned hash chain from the span tree.

        The chain provides integrity (tamper-evidence). Signing is
        handled server-side at trace ingestion for authenticity.
        """
